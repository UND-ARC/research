...
% Spacecraft point
\draw (0,6) -- (2,5);
\draw (3,5.5) node[anchor=west] {$(x_1, y_1, z_1)$};
\draw[densely dotted] (2,5) -- (3,5.5);
\draw[dashed] (2,5) -- (2,-1); 
\draw (0,0) -- (2,5);
...
\draw[decorate,decoration={brace,amplitude=4pt},xshift=2pt,yshift=0pt,mirror]
  (0,6) -- (0,6.3896) node[black,midway,yshift=0pt,xshift=4pt] {$\beta$};
